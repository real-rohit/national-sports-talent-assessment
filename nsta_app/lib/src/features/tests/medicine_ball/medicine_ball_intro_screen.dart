...
class MedicineBallIntroScreen extends StatefulWidget {
  const MedicineBallIntroScreen({super.key});

  @override
  State<MedicineBallIntroScreen> createState() =>
      _MedicineBallIntroScreenState();
}

class _MedicineBallIntroScreenState extends State<MedicineBallIntroScreen> {
  @override
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            Text(AppLocalizations.of(context)!.medicineBallThrow,
                style:
                    const TextStyle(fontSize: 20, fontWeight: FontWeight.w800)),
            const SizedBox(height: 8),
            Text(
              AppLocalizations.of(context)!.medicineBallInstruction,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    AppLocalizations.of(context)!.upperBodyStrength,
